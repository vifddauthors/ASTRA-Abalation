    ...
    if 'mos' in name:
        ...
        if args["model_name"] == "mos":
            ...
            if name == "vit_base_patch16_224_mos":
                model = vit_mos.vit_base_patch16_224_mos(num_classes=args["nb_classes"],class_frequencies=args["class_frequencies"],
                    global_pool=False, drop_path_rate=0.0, tuning_config=tuning_config)
            elif name == "vit_base_patch16_224_in21k_mos":
                model = vit_mos.vit_base_patch16_224_in21k_mos(num_classes=args["nb_classes"], class_frequencies=args["class_frequencies"],
                    global_pool=False, drop_path_rate=0.0, tuning_config=tuning_config)
            else:
